...
> 因此有
>$$
P(|x-\mu|\geq \varepsilon)=P(e^{\lambda |x-\mu|}\geq e^{\lambda \varepsilon})\leq e^{-\lambda a}\E(e^{\lambda |x-\mu|})\Longleftrightarrow P(|x-\mu|\geq \varepsilon)\leq \min_{\lambda>0}e^{-\lambda a}\E(e^{\lambda |x-\mu|})
>$$
...
> 当$\|u\|^2\geq 1$时：
> $$
P(\|u\|^2-1\geq \varepsilon )=P(\|u\|^2\geq 1+\varepsilon)\leq\min_{\lambda>0}e^{-\lambda(\varepsilon +1)}\E(e^{\lambda\|u\|^2})
> $$
> $$
\begin{aligned}
\E(e^{\lambda\|u\|^2})&=\E (e^{\lambda \sum u_i ^2})\\
&=\prod_{i=1}^n \E(e^{\lambda u_i^2})\\
...
> 当$\|u\|^2<1$时
> $$
P(1-\|u\|^2\leq \varepsilon)\leq \min_{\lambda>0}e^{-\lambda\varepsilon}\E(e^{\lambda (1-\|u\|^2)})=\min_{\lambda>0}e^{-\lambda (\varepsilon-1)}E(e^{-\lambda \|u\|^2})
> $$
> $$
\begin{aligned}
\E(-\lambda \|u\|^2)&= \E(e^{-\lambda \sum u_i^2})\\
&=\prod_{i=1}^n \E(e^{-\lambda u_i^2})\\
&=\prod_{i=1}^n \int_{-\infty}^{\infty}\frac{\sqrt{n}}{\sqrt{2\pi}}\exp(-\frac{nu_i^2}{2})\exp(-\lambda u_i^2)\rmd u_i\\
